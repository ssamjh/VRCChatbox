...
def load_app_config():
    ...
    default_config = {
        ...
        "slide": {
            ...
            "cooldown_min": 5.0,   # Minimum per-shocker cooldown after a probability shock (seconds)
            "cooldown_max": 20.0,  # Maximum per-shocker cooldown after a probability shock (seconds)
